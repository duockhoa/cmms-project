...
const update_technical_profile_dto_1 = require("./dto/update-technical-profile.dto");
const update_availability_dto_1 = require("./dto/update-availability.dto");
let UsersController = class UsersController {
    constructor(usersService) {
        this.usersService = usersService;
    }
    async getUsers(role, includeInactive) {
...
__decorate([
    (0, common_1.Patch)(':id/technical-profile'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_technical_profile_dto_1.UpdateTechnicalProfileDto]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "updateTechnicalProfile", null);
__decorate([
