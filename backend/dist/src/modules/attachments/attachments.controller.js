...
let AttachmentsController = class AttachmentsController {
    ...
    async uploadFile(file, entityType, entityId, uploadedById, description) {
        return this.attachmentsService.uploadFile(file, entityType, entityId, uploadedById, description);
    }
    ...
    async deleteFile(id, expectedVersionStr) {
...
__decorate([
    ...
    __param(3, (0, common_1.Body)('uploadedById')),
...
__decorate([
    ...
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Query)('expectedVersion')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
